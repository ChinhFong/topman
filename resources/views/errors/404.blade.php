    ...
    <div class="absolute-center">
        <div class="text-center">
            <div class="header-full-title">
                <img src="img/icon-flag/topuse.png" class="img-responsive">
            </div>
            {{-- <div class="title-logo animated fadeInDown animation-delay-5">nbsp;<span>មេនផៅវ័រ</span></a></h1></div> --}}
            <div class="transparent-div animated fadeInUp animation-delay-8">
                <br/>
                <br/><br/>
                <h1> {{trans('404.404')}}</h1>
                <h2>{{trans('404.pagenotfound')}}</h2>
                <p>{{trans('404.content1')}} <br> {{trans('404.content2')}}</p>
                <a href="/" class="btn btn-ar btn-primary btn-lg">{{trans('404.btn')}}</a>
            </div>
        </div>
    </div>
</div>
